...
#args=c("/projects/compsci/jgeorge/USERS/alizae/GBM/matching_patients/R_Code/sc_pipeline","Fig1/AllPBMC/GEXResAll/Configs/")

################# LOAD UTILS  ##############

print("Just started")
source("/projects/compsci/jgeorge/USERS/alizae/GBM/matching_patients/R_Code/sc_pipeline/ref_utils.R")
...
U1 <- plot_umap(
  ...
  group_by = config$umap_plot_group,
